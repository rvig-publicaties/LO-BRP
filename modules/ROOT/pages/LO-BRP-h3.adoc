...
Wanneer een afnemersindicatie onvoorwaardelijk fysiek wordt verwijderd bij een PL wordt de categorie waarin de betreffende indicatie actueel en/of historisch voorkomt in zijn geheel fysiek bij de PL verwijderd, ongeacht de datum in <<e9510,85.10>> Ingangsdatum geldigheid in die categorie.
...
Aan de hand van bovengenoemde gegevens wordt een bericht samengesteld zoals is beschreven in <<_opbouw_van_de_berichtendienst_berichten>> Opbouw van de berichtendienst berichten.
...
Bij de verstrekking van verwijsgegevens aan gemeenten en aan de RNI zullen de elementen <<e8310,83.10>> en <<e8320,83.20>> meeverstrekt worden als één of meer van de betreffende verwijsgegevens in onderzoek staan.
