...
De privacyprocedures zoals beschreven in <<_bijhouding>> van het Logisch Ontwerp (LO) BRP zijn van kracht. Het systeem protocolleert daarom alle verstrekkingen, onder meer voor het inzagerecht van de burger. De bewaartermijn van deze protocolgegevens is 20 jaar.
