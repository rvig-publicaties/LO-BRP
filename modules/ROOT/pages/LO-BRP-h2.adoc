...
Indien voor een persoon het bijzonder Nederlanderschap van toepassing is, mag deze procedure niet uitgevoerd worden, maar moet de procedure Opnemen bijzonder Nederlanderschap worden uitgevoerd.

Indien een persoon Nederlander wordt, moet voor alle andere reeds geregistreerde nationaliteiten de procedure Beëindigen nationaliteit dan wel de procedure Wijziging in de reden beëindigen nationaliteit dan wel de procedure Verwijderen van nationaliteitsgegevens worden uitgevoerd.
...
Indien een persoon de status Behandeld als Nederlander verkrijgt, moet voor alle andere reeds geregistreerde nationaliteiten de procedure Beëindigen nationaliteit dan wel de procedure Wijziging in de reden beëindiging nationaliteit dan wel de procedure Verwijderen van nationaliteitsgegevens worden uitgevoerd.
...
Op schriftelijk verzoek van de ingeschrevene kunnen de gegevens van nationaliteiten verwijderd worden in geval van adoptie of in geval dat iemand de Nederlandse nationaliteit of de aanduiding Bijzonder Nederlanderschap al heeft sinds de geboorte of eerste inschrijving in de BRP.

In geval van adoptie worden alle actuele en historische categorieën met betrekking tot de door de adoptie-uitspraak verloren nationaliteit(en) verwijderd van de PL.

In geval dat iemand de Nederlandse nationaliteit of de aanduiding Bijzonder Nederlanderschap al heeft sinds de geboorte of eerste inschrijving in de BRP worden alle actuele en historische categorieën verwijderd met betrekking tot de vreemde nationaliteiten die de persoon niet al had voordat hij de Nederlandse nationaliteit of de aanduiding bijzonder Nederlanderschap kreeg.

Ook zonder schriftelijk verzoek worden, nadat de Nederlandse nationaliteit of de aanduiding 'Bijzonder Nederlanderschap'’ is geregistreerd, alle huidige en historische categorieën met betrekking tot eventuele andere nationaliteiten verwijderd van de persoonslijst. Dit gebeurt alleen als de persoon die vreemde nationaliteiten niet al had voordat hij de Nederlandse nationaliteit of de aanduiding bijzonder Nederlanderschap kreeg.
