...
In tabel <<t34,34>>, de Landentabel, komt het element 99.97 Indicatie einddatum fictief voor. Als hier een asterisk (*) in staat, betekent dit dat er geen officiële bron is voor de datum in element 99.99, of dat de datum in 99.99 niet overeenkomt met de officiële datum waarop het betreffende land een andere naam kreeg of ophield te bestaan.

====== Nieuwe gemeentecode

In tabel <<t33,33>>, de Gemeententabel, komt het element 92.12 Nieuwe gemeentecode voor. De functie van dit element is de volgende: wanneer in een tabelregel een datum beëindiging voorkomt, verwijst de nieuwe gemeentecode naar een andere tabelregel uit dezelfde tabel. Op deze manier vindt er een doorverwijzing plaats naar een andere tabelregel zonder datum beëindiging. Deze laatste tabelregel bevat de gemeentecode die op dat moment geldig is.
...
Toelichting:: De (geslachts)naam waarvan de eventueel aanwezige voorvoegsels (tabel <<t36,36>>) en adellijke titel/predicaat (tabel <<t38,38>>) zijn afgesplitst.
Lengte:: 1-200
Type:: Alfanumeriek
Standaardwaarde:: .
...
Toelichting:: Een code, opgenomen in tabel <<t33,33>>, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar de persoon is geboren.
Lengte:: 1-40
Type:: Alfanumeriek
...
Standaardwaarde indien onbekend.
Voorwaarden:: Indien het huwelijk/geregistreerd partnerschap is ontbonden in Nederland, bevat dit veld of een 4-cijferige code uit tabel <<t33,33>> Gemeententabel of een omschrijving zo nodig aangevuld met een aanduiding in lengte- en breedtegraden, indien het huwelijk/­geregistreerd partnerschap niet is ontbonden in een gemeente. +
...
Toelichting:: Een code, opgenomen in tabel <<t56,56>>, Verblijfstiteltabel, die aangeeft over welke verblijfsrechtelijke status de ingeschrevene beschikt.
Lengte:: 2
Type:: Numeriek
Standaardwaarde:: 00
...
Toelichting:: Een code, opgenomen in tabel <<t33,33>>, Gemeententabel, die aangeeft in welke gemeente de akte in de registers van de burgerlijke stand in Nederland is opgenomen.
Lengte:: 4
Type:: Numeriek
Standaardwaarde:: 0000
Mogelijke waarden:: Een 4-cijferige code volgens de tabel <<t33,33>>, Gemeententabel +
...
Toelichting:: Een code, voorkomend in tabel <<t60,60>>, RNI-deelnemerstabel, die aangeeft welke RNI-deelnemer (een deel van) de gegevens in de betrokken categorie heeft aangeleverd.
Lengte:: 4
Type:: Numeriek
Standaardwaarde:: 0000
Mogelijke waarden:: Een 4-cijferige code volgens de tabel <<t60,60>>, RNI‑deelnemerstabel. +
Standaardwaarde indien onbekend.
Voorwaarden:: {empty}
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e0510,05.10>> Nationaliteit
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e0320,03.20>> Geboorteplaats +
<<e0620,06.20>> Plaats huwelijkssluiting/aangaan geregistreerd partnerschap +
<<e0720,07.20>> Plaats ontbinding huwelijk/geregistreerd partnerschap +
<<e0820,08.20>> Plaats overlijden +
<<e0910,09.10>> Gemeente van inschrijving +
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e0330,03.30>> Geboorteland +
<<e0630,06.30>> Land huwelijkssluiting/aangaan geregistreerd partnerschap +
<<e0730,07.30>> Land ontbinding huwelijk/geregistreerd partnerschap +
<<e0830,08.30>> Land overlijden +
<<e1310,13.10>> Land adres buitenland +
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e4010,40.10>> Afnemersindicatie
...
|===
Gebruikt in element:: <<e0230,02.30>> Voorvoegsel geslachtsnaam
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e6310,63.10>> Reden opname nationaliteit +
<<e6410,64.10>> Reden beëindigen nationaliteit
...
"predicaat"
|===
Gebruikt in element:: <<e0220,02.20>> Adellijke titel/predicaat
...
||Alfanumeriek |1-80 posities|
|===
Gebruikt in element:: <<e8120,81.20>> Aktenummer
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e0740,07.40>> Reden ontbinding huwelijk/geregistreerd partnerschap
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e3510,35.10>> Soort Nederlands reisdocument
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e3540,35.40>> Autoriteit van afgifte Nederlands reisdocument
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e3910,39.10>> Aanduiding verblijfstitel
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e8810,88.10>> RNI-deelnemer
...
||Numeriek |8 posities |jjjjmmdd
|===
Gebruikt in element:: <<e3210,32.10>> Indicatie gezag minderjarige
...
| | 2+|naam| obect |
| | | |volledigeNaam |string |<<eNM02,PA.NM.02>> Volledige naam van de bewoner
| | 2+|geboorte | object |
| | | |datum |date |Gebaseerd op <<e0310,01.03.10>> Geboortedatum op de PL van de bewoner
...
| 3+|type |string |"EenhoofdigOuderlijkGezag" / "GezagNietTeBepalen" / "GezamenlijkGezag" / "GezamenlijkOuderlijkGezag" / "TijdelijkGeenGezag" / "Voogdij"
...
| 3+|inOnderzoek |boolean |Geeft aan dat de gezagsrelatie in onderzoek is
...
| | | |volledigeNaam |string | <<eNM02,PA.NM.02>> Volledige naam van de PL van de ouder
| 3+|derde |object |
| | 2+|type |string |"BekendeDerde" / "OnbekendeDerde"
| | 4+|Als type = "BekendeDerde":
...
| 5+|Als type = "GezamenlijkOuderlijkGezag":
